                        ...
                        @endif
                            ...
                            <label class="input login-input">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="User Name" name="username" class="form-control" value="@if(isset($name)) {{$name}}@endif">
                                </div>
                            </label>
                        </section>
                        <section>
                            <label class="input login-input no-border-top">
                                <div class="input-group">
                                    ...
                                    <input type="password" placeholder="Password" name="password" class="form-control" value="@if(isset($password)) {{$password}}@endif">
                                </div>
                            </label>
                        </section>

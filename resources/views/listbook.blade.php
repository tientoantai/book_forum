                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ul class="list-inline right-topbar pull-right">
                            ...
                            <li><a href="shop-ui-login.html">name</a> | <a href="/logout">Logout</a>
                            </li>
                    ...
                    <section>
                        <div class="table-responsive">
                            <div class="btn btn-success">
                                <a href="/insert"><i class="glyphicon glyphicon-plus"></i></a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 md-margin-bottom-40">
                                ...
                                <div class="billing-info-inputs checkbox-list">
                                    ...
                                    <input id="billingAddress" type="text" placeholder="Address Line 1" name="address1"
                                           class="form-control required">
                                    <input id="billingAddress2" type="text" placeholder="Address Line 2" name="address2"
                                           class="form-control required">
                                    <div class="row">
                                        <div class="col-sm-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="billing-info-inputs checkbox-list">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <input id="name2" type="text" placeholder="First Name" name="firstname"
                                                   class="form-control">
                                            <input id="email2" type="text" placeholder="Email" name="email"
                                                   class="form-control email">
                                        </div>
                                        <div class="col-sm-6">
                                            <input id="surname2" type="text" placeholder="Last Name" name="lastname"
                                                   class="form-control">
                                            <input id="phone2" type="tel" placeholder="Phone" name="phone"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <input id="shippingAddress" type="text" placeholder="Address Line 1" name="address1"
                                           class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="zip2" type="text" placeholder="Zip/Postal Code" name="zip"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOne-v2" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    ...
                                                    hendrerit, felis vel tincidunt sodales, urna metus rutrum leo, sit
                                                    amet finibus velit ante nec lacus. Cras erat nunc, pulvinar nec leo
                                                    at, rhoncus elementum orci. Nullam ut sapien ultricies, gravida ante
                                                    ut, ultrices nunc.
                                                </div>
                                            </div>
                                        </div>
...
<div class="g-popup-wrapper">
    <div class="g-popup g-popup--subscribe text-center">
        ...
        <form action="#" class="sky-form">
            <div class="row">
                ...
                <section class="col-sm-3">
                    <label class="input">
                        <button class="btn-u btn-u-default" type="button">Get Updates</button>
                    </label>
                </section>
            </div>
        </form>
        <div class="no-spam">
            <span class="icon-lock" aria-hidden="true"></span> We hate SPAM and promise to keep your email address safe.
        </div>

        <a href="javascript:void(0);" class="g-popup__close g-popup--subscribe__close"><span class="icon-close"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="destroy">Delete</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->

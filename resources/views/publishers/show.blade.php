@extends('books.layout')
        ...
        <div class="container">
            <ul class="breadcrumb-v5">
                <li><a href="{{route('publishers.admin')}}"><i class="fa fa-home"></i></a></li>
            ...
            <div class="row">
                    <div class="col-md-4 md-margin-bottom-50">
                        <div class="ms-showcase2-template">
                            <img class="full-width img-responsive" src="" alt="" style="width:70%">
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <h3 class="shop-product-title">Address</h3>
                                <span>{{$publisher->getAddress()}}</span>
                </div>
            </div><!--/end robw-->
        </div>

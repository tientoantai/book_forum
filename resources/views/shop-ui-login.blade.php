						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="active"><a href="{{route('shop-ui-login')}}">Login</a></li>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5">
						...
						<p class="text-center">Don't have account yet? Learn more and <a href="{{route('shop-ui-register')}}">Sign Up</a></p>
					</div>
				</div><!--/end row-->
			</div><!--/end container-->
		</div>
